...
RUN apt-get update && apt-get install -y libonig-dev libjpeg-dev libxslt1-dev libxml2-dev libicu-dev libpng-dev libwebp-dev rsync openssh-client git zip unzip php8.1-imagick
